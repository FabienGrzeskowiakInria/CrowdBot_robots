...
{
    public class TwistPublisher : Publisher<Messages.Geometry.Twist>, Publisher
    {
        ...
        public void UpdateMessage()
        {
            ...
            message.linear = GetGeometryVector3(PublishedTransform.localPosition.Unity2Ros());
            message.angular = GetGeometryVector3(refactor_angle(PublishedTransform.localRotation.eulerAngles).Unity2Ros());
        ...
        private Vector3 refactor_angle(Vector3 vector3)
        {
            return new Vector3( (vector3.x + 180.0f)%360 - 180.0f,(vector3.y + 180.0f)%360 - 180.0f,(vector3.z + 180.0f)%360 - 180.0f);
        }
    }
}
